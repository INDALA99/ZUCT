...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.get(baseUrl + "/findByenrol/:key", authorize([]), CourseController.findByenrol);
    router.get(baseUrl + "/findBytutor/:key", authorize([]), CourseController.findBytutor);
  ...
  *
  */
  findByenrol: async (req, res) => {
    try {
      const result = await CourseModel.findByenrol(req.params.key);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  */
  findBytutor: async (req, res) => {
    try {
      const result = await CourseModel.findBytutor(req.params.key);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
